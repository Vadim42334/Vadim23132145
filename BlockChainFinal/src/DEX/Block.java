...
public class Block {
	...
	public static ArrayList<transactionData> setBlock(transactionData tx, ArrayList <transactionData> bd) throws InvalidKeyException, NoSuchAlgorithmException, SignatureException 	// добавляем транзакции в блок
    {	
	...
	public static void transactionDataOutput(ArrayList<transactionData> bd) // Вывод id всех транзакций
    {	
