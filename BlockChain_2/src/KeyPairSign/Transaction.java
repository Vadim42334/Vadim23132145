...
public class Transaction {
	...
	public static void main(String args[])
     {
		...
		public static transactionData createTransaction(operationData[] op) throws IOException
    	{
	...
	public static operationData[] transactions(operationData op, operationData[] od) 	// добавляем операцию в массвив транзакции.
    {
		int i = 0;
		if(od[i] != null) {								 // если ячейка в массиве операций занята - записываем операцию в следующую ячейку.
			od[i+1] = op;
		} else {od[i] = op;}
		return od; 
    }
