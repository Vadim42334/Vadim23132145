...
public class hash {
    ...
    {       
       ...
       // String SHA1 = "SHA-1"; 		
        byte[] hashResult = hashFunction(text.getBytes(UTF_8), SHA3);
        String hashText = bytesToHex(hashResult);
        return hashText;
    }
    public static byte[] hashFunction(byte[] text, String algorithm) { 			// Хеширование
        MessageDigest alg;
        try {
