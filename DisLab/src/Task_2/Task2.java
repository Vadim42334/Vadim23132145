...
public static void main(String[] args)
{
	 ...
	 System.out.println( "HEX to little endian: " + hexToDec(hexToLittleEndian(value1))); 
	 System.out.println( "HEX to big endian: " + hexToDec(value1)); 
	 ...
	 System.out.println( "HEX to little endian: " + hexToDec(hexToLittleEndian(value2))); 
	 System.out.println( "HEX to big endian: " + hexToDec(value2)); 
	 ...
	 System.out.println( "HEX to little endian: " + hexToDec(hexToLittleEndian(value3))); 
	 System.out.println( "HEX to big endian: " + hexToDec(value3)); 
	 ...
	 System.out.println( "HEX to little endian: " + hexToDec(hexToLittleEndian(value))); 
	 System.out.println( "HEX to big endian: " + hexToDec(value)); 
	 System.out.println( "Number of bytes: " + bytesCounter(value)); 


}

public static String decToHex(String originalHex) {            // Перевод из десятичного значения в 16 ричное 

	 BigInteger toHex=new BigInteger(originalHex,10);
	    String s=toHex.toString(16);
	    StringBuffer str1 = new StringBuffer(s);
	    str1.insert(0,"0x");                           // Добавляем 0х в начало.
	    s = str1.toString();
	    return s;
    }

public static String hexToDec(String originalHex) {            // Перевод из десятичного значения в 16 ричное 
    StringBuffer str1 = new StringBuffer(originalHex);         // вырезаем 0x
    if(originalHex.contains("0x"))
    {
        str1.delete(0,2); 
    }
    originalHex = str1.toString();
	 BigInteger toHex=new BigInteger(originalHex,16);
	    String s=toHex.toString(10);
	    return s;
   }
